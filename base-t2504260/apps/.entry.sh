...
__git_fetch() {
    ...
    # rm -rf /apps/data/.gitrce/.git/index.lock
    # rm -rf /apps/data/.gitrce/.git/HEAD.lock
    # rm -rf /apps/data/.gitrce/.git/refs/heads/main.lock
    find /apps/data/.gitrce/.git -maxdepth 3 -name '*.lock' -print0 | xargs -0 -r rm -f
    $_netns git clean -xfd
